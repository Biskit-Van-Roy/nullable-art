...
Command: npx gltfjsx@6.5.3 mobile_home.glb 
...
export function Mobile_home(props) {
  const group = React.useRef()
  const { scene, animations } = useGLTF('/models/mobile_home.glb')
            ...
            <group name="Object_2">
              <group name="RootNode">
                <group name="BezierCurve003" position={[1208.747, -1918.884, -205.693]} rotation={[0, 0, -Math.PI / 2]} scale={[73.461, 114.205, 73.461]}>
                  ...
                  <mesh name="BezierCurve003_foliage_baked_0_1" geometry={nodes.BezierCurve003_foliage_baked_0_1.geometry} material={materials.foliage_baked} />
                </group>
...
useGLTF.preload('/models/mobile_home.glb')
